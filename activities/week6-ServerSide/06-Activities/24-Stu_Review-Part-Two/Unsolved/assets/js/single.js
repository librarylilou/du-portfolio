...
var getRepoName = function () {
  ...
  // TODO: Write your answer here-- html? user input?
  ...
  if (repoName) {
    ...
    // TODO: Write your answer here-- if repoName is truer than true
  ...
  fetch(apiUrl).then(function (response) {
    if (response.ok) {
      response.json().then(function (data) {
        ...
        // TODO: Write your answer here--  if response.ok false and
